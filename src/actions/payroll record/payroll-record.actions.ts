...
export const getPayrollRecordCollectionFailure = (): GetPayrollRecordCollectionFailureAction => {
  return {
...
export const createPayrollRecordFailure = (): CreatePayrollRecordFailureAction => {
  return {
